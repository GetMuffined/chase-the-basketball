...
sprites.onOverlap(SpriteKind.Player, SpriteKind.BasketBall, function (sprite, otherSprite) {
    ...
    info.startCountdown(randint(13, 15) - randint(7, 12))
})
...
mySprite2 = sprites.create(img`
    . . . . . f f f f f f f . . . . . 
    . . . f f 2 2 2 2 1 2 2 f f . . . 
    . . f 2 2 2 2 2 2 1 2 2 2 2 f . . 
    . f 1 1 1 1 1 2 2 1 1 1 1 1 1 f . 
    . f 4 4 4 4 1 1 1 1 1 4 4 4 4 f . 
    f 4 4 4 4 1 1 1 1 4 4 1 5 5 5 5 f 
    f 5 5 5 1 1 5 5 1 5 5 5 1 5 5 5 f 
    f 5 5 1 5 5 5 5 1 1 7 7 5 1 1 5 f 
    1 1 1 1 1 7 7 7 7 1 7 7 7 7 7 1 1 
    f 7 1 7 1 1 7 7 7 1 1 7 7 7 7 7 f 
    f 1 1 7 7 1 7 7 7 6 1 6 6 6 6 6 f 
    f 1 6 6 6 1 1 6 6 6 1 6 6 6 6 6 f 
    . f 6 6 6 6 1 6 6 6 1 6 6 8 8 f . 
    . f 8 8 8 8 1 8 8 8 8 1 8 8 8 f . 
    . . f 8 8 8 1 8 8 8 8 1 8 8 f . . 
    . . . f f 8 1 1 8 8 8 1 f f . . . 
    . . . . . f f f f f f f . . . . . 
